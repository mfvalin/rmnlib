...
void Test102(void)
{
   ...
   fprintf(stderr, "Test #102 : Erreur normale en essayant d'encoder IP1, IP2 et IP3 d'après les structures ip_info {%f, %f, %d} et {%f, %f, %d}\n",
           fp1.v1, fp1.v2, fp1.kind, fp2.v1, fp2.v2, fp2.kind);
...
void Test107(void)
{
   ...
   fprintf(stderr, "Test #107 : Erreur normale en essayant d'encoder IP1, IP2 et IP3 d'après les structures ip_info {%f, %f, %d} et {%f, %f, %d}\n",
           fp1.v1, fp1.v2, fp1.kind, fp2.v1, fp2.v2, fp2.kind);
